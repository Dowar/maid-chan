...
exports.run = async (client, message, args, level, now, mentionned) => 
{
    ...
    if (!mentionned)
    {
        ...
        else
        {
            ...
            message.channel.send(`**${client.user.username}** fait un câlin virtuel :hugging: à **${nickname}**`)
            calin.number++
            maidcalin.timer = now
    ...
    else 
    {
        ...
        else
        {
            ...
            else
            {
                ...
                message.channel.send(`**${message.author.nickname}** fait un câlin virtuel :hugging: à **${nickname}**`)
