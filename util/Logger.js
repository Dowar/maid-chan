...
exports.log = (content, type = "log") => 
{
  ...
  switch (type) 
  {
    ...
    case "pret": {return console.log(`${timestamp} ${chalk.black.bgGreen(type.toUpperCase())} ${content}`)}
    default: throw new TypeError("Le type doit etre warn, debug, log, ready, cmd or error.")
  }
}
